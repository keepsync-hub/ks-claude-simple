...
### → [Claude Cowork](./04-claude-cowork.md)
Cómo configurar Claude Cowork de la forma correcta.
**Nivel:** Intermedio | **Duración:** 18 minutos

### → [Claude para equipos](./05-claude-para-equipos.md)
Cómo implementar Claude en todo tu equipo en una semana.
**Nivel:** Intermedio | **Duración:** 11 minutos

### → [Claude Design](./06-claude-design.md)
Cómo usar el nuevo Claude para diseño.
**Nivel:** Intermedio | **Duración:** 9 minutos

### → [Claude Cowork + Proyectos](./07-claude-cowork-proyectos.md)
Cómo crear Proyectos dentro de Cowork para trabajar mejor en equipo.
**Nivel:** Intermedio | **Duración:** 10 minutos

### → [Claude para presentaciones](./08-claude-para-presentaciones.md)
La mejor forma de crear presentaciones con Claude.
**Nivel:** Intermedio | **Duración:** 7 minutos

### → [Claude Skills](./09-claude-skills.md)
Cómo crear tus primeras Skills (habilidades) de Claude.
...
### → [Conectores de Claude](./16-conectores-claude.md)
Cómo conectar Claude a tus aplicaciones.
**Nivel:** Experto | **Duración:** 8 minutos

### → [Claude Code — Vibecoding](./17-claude-code-vibecoding.md)
Para personas que nunca, jamás, van a programar.
**Nivel:** Experto | **Duración:** 14 minutos

### → [No uses tu Claude personal en el trabajo](./18-no-uses-tu-claude-personal-en-el-trabajo.md)
A menos que quieras que te despidan o te demanden.
**Nivel:** Experto | **Duración:** 9 minutos

---

*Fuente de inspiración: colección [Claude101](https://claude101.com) de Ruben Hassid, adaptada y traducida al español, complementada con referencias a [Anthropic Academy](https://anthropic.skilljar.com).*

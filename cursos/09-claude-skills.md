...
Las Skills son flujos guardados que activas con un comando tipo `/brief`, `/linkedin` o `/contrato-x`.
...
**Paso 1:** abre Cowork. Asegúrate de estar en Opus + Thinking extendido. Escribe:
...
Existen herramientas web gratuitas donde describes la Skill (cuanto más detalle, mejor), la descargas y la subes a Claude.
...
- **Minutos 0-5:** abre Cowork. Escribe: "Usa el skill-creator para ayudarme a armar una skill para [tu tarea más repetida]."
